...
public class Splash_GUI extends javax.swing.JFrame {
                ...
                for (int i = 0; i < 101; i++) {
                    try {
                        ...
                        if (progressBar.getValue() == 10) {
                            ...
                            message_lbl.setText("Fazendo a conexao com o banco de dados");
                            sleep(2000);

                        } else if (progressBar.getValue() <= 30) {
                            message_lbl.setText("Carregando o sistema");
                            sleep(100);
                        } else if (progressBar.getValue() <= 99) {
                            message_lbl.setText("Carregamento quase completo");

                        } else {
                            message_lbl.setText("Carregamento completo. Seu programa sera iniciado.");
    ...
    private void initComponents() {
        ...
        progressBar.setForeground(new java.awt.Color(255, 223, 43));
        jPanel1.add(progressBar);
        progressBar.setBounds(140, 240, 240, 10);

        message_lbl.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        ...
        message_lbl.setText("jLabel1");
        jPanel1.add(message_lbl);
        message_lbl.setBounds(140, 250, 240, 20);
